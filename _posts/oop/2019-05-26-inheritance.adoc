...
image::https://static.studytonight.com/java/images/types-of-inheritance.png
...
image::https://static.studytonight.com/java/images/multiple-inheritance-problem.jpg
