...
:page-idn       : ba1b1fabc1279658359e8cdbb55af5470d8a7ce81117dbd557222f115129d17b

Ini adalah rangkuman tentang SOLID yang saya pelajari di Dicoding.


. Single Responsibility Principle (SRP),
Sebuah class hanya melalukan satu tugas tertentu. Jika terdapat satu class yang memiliki dua tugas, maka sebaiknya dibuat dalam dua class yang berbeda.
