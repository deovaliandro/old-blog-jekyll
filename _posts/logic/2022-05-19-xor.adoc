...
:page-math      : true
:page-desc      : XOR adalah salah satu salah satu gerbang logika yang unik, karena jika operasinya dilakukan sebanyak genap kali, maka akan menghasilkan nilai semula.
